"""
Web application for the New RVC project.
...
def render_app() -> gr.Blocks:
    """
    Render the New RVC web application.
...
def _init_dropdowns() -> list[gr.Dropdown]:
    """
    Initialize the New RVC web application by updating the choices
...
def start_app(
    ...
    """Run the New RVC web application."""
